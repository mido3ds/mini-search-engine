...
public class KeywordsExtractor {
	...
	private static final Pattern HTML_TAGS = Pattern.compile("</?(!doctype html|a|abbr|address|area|article|aside" +
		"|audio|b|base|basefont|bdi|bdo|big|blockquote|body|br|button|canvas|caption|center|cite" +
		"|code|col|colgroup|data|datalist|dd|del|details|dfn|dialog|dir|div|dl|dt|em|embed|fieldset" +
		"|figcaption|figure|font|footer|form|frame|frameset|h1|head|header|hr|html|i|iframe|img" +
		"|input|ins|kbd|label|legend|li|link|main|map|mark|meta|meter|nav|noframes|noscript" +
		"|object|ol|optgroup|option|output|p|param|picture|pre|progress|q|rp|rt|ruby|s|samp|" +
		"script|section|select|small|source|span|strike|strong|sub|summary|sup|svg|table|tbody|td|template|" +
	...
	private static final Pattern STOP_WORDS = Pattern.compile("\\b[^\\w -]*(i|me|my|myself|we|our|ours|ourselves" +
		"|you|you're|you've|you'll|you'd|your|yours|yourself|yourselves|he|him|his|himself|she" +
		...
		"|not|only|own|same|so|than|too|very|s|t|can|will|just|don|don't|should|should've" +
		...
		"|weren't|won|won't|wouldn|wouldn't)[^\\w -]*\\b");
